...
You’ll analyze their computational efficiency, measure performance on increasing input sizes,  
...
### Example Output
[profiling] strategy=NaiveMovingAverageStrategy ticks=100000 time_best=3.52s memory_peak=255.7MiB
[profiling] strategy=NaiveMovingAverageStrategyOptimized ticks=100000 time_best=0.31s memory_peak=62.3MiB
...
- Check that the optimized strategy runs under 1 second and uses <100 MB memory for 100k ticks.
